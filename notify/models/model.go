...
type NotificationUUID struct {
	ID        string        `gorm:"column:id;primary_key;default:gen_random_uuid();type:uuid" json:"id"`
	Link      string     `gorm:"column:link" json:"link"`
...
type NotificationStatusUUID struct {
	ID         int64        `gorm:"column:id;primary_key;default:gen_random_uuid();type:uuid" json:"id"`
